            ...
            <ul className={styles.featuresList}>
              ...
              >
                ...
                <p className={styles.featureDescription}>
                  ...
                  behandelt, um maßgeschneiderte Lösungen für Ihre Bedürfnisse
                  zu bieten.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p className={styles.featureDescription}>
                  Ich nutze die neuesten Technologien und Tools, um Ihre
                  Projekte effizient und zukunftssicher zu gestalten.
                </p>
              </li>
              <li
                data-aos="fade-up"
              ...
              >
                ...
                <p className={styles.featureDescription}>
                  Ihre Zufriedenheit steht im Mittelpunkt, und jedes Projekt
                  wird mit höchster Präzision und Qualität realisiert.
                </p>
              </li>
            </ul>
          </div>
